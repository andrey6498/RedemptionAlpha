...
namespace Redemption.Globals
{
    ...
    public sealed class ItemTags
    {
        ...
        public static void SetItemTags()
        {
            ...
            Blood.SetMultiple(ItemID.BloodButcherer, ItemID.Bladetongue, ItemID.DeathbringerPickaxe, ItemID.BloodLustCluster, ItemID.BloodHamaxe, ItemID.FleshGrinder, ItemID.PsychoKnife);
    ...
    public sealed class ProjectileTags
    {
        ...
        public static readonly TagData Explosive = ContentTags.Get<GroupProj>(nameof(Explosive));
        ...
        public static void SetProjTags()
        {
            ...
            Psychic.SetMultiple(ProjectileID.BrainScramblerBolt, ProjectileID.MedusaHeadRay, ProjectileID.BookStaffShot, ProjectileID.InsanityShadowHostile, ProjectileID.InsanityShadowFriendly, ModContent.ProjectileType<Cystling>(), ModContent.ProjectileType<Rockslide_Proj>(), ModContent.ProjectileType<TwinfaceSoulless_Slash_Proj>(), ModContent.ProjectileType<TwinfaceSoulless_Slash_Proj2>());
